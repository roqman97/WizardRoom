...
namespace NewtonVR
{
    public class NVRHand : MonoBehaviour
    {
        ...
        private EVRButtonId TouchButton = EVRButtonId.k_EButton_SteamVR_Touchpad;
        public bool TouchButtonDown = false;
        public bool TouchButtonUp = false;
        public bool TouchButtonPressed = false;
        public float TouchButtonAxis = 0f;
